...
const propertySchema = joi.object({
    ...
    size: joi.string().trim().required().error(new Error('size is required and can not be empty')),
    typeof_size: joi.string().trim().required().error(new Error('type of size is required and can not be empty')),
    price: joi.string().trim().required().error(new Error('price is required and can not be empty')),
    total: joi.string().trim().required().error(new Error('total is required and can not be empty')),
